...
if distance_km:
    ...
    fuel_cost_petrol = calculate_fuel_cost(fuel_needed_petrol, fuel_price_petrol)
    print(f"Fuel cost for the trip (Petrol): {fuel_cost_petrol:.2f} INR")
    ...
    fuel_cost_diesel = calculate_fuel_cost(fuel_needed_diesel, fuel_price_diesel)
    print(f"Fuel cost for the trip (Diesel): {fuel_cost_diesel:.2f} INR")
